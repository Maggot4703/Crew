...
from .otBase import (CountReference, FormatSwitchingBaseTable, OTTableReader,
...
from .otTables import (InsertionMorphAction, LigatureMorphAction, MorxSubtable,
                       VarCompositeGlyph, lookupTypes)
