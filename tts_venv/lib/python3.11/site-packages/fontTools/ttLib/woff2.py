...
from fontTools.ttLib import (TTFont, TTLibError, getSearchRange, getTableClass,
                             getTableModule)
from fontTools.ttLib.sfnt import (DirectoryEntry, SFNTDirectoryEntry,
                                  SFNTReader, SFNTWriter, WOFFFlavorData,
                                  calcChecksum, sfntDirectoryEntrySize,
                                  sfntDirectoryFormat, sfntDirectorySize)
