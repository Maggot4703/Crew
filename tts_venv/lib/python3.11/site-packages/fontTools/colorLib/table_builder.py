...
from fontTools.ttLib.tables.otBase import (BaseTable, FormatSwitchingBaseTable,
                                           UInt8FormatSwitchingBaseTable)
from fontTools.ttLib.tables.otConverters import (ComputedInt, FloatValue,
                                                 IntValue, OptionalValue,
                                                 Short, SimpleValue, Struct,
                                                 UInt8, UShort)
