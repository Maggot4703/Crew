...
class FontBuilder(object):
    ...
    def setupCFF(self, psName, fontInfo, charStringsDict, privateDict):
        from .cffLib import (CFFFontSet, CharStrings, GlobalSubrsIndex,
                             PrivateDict, TopDict, TopDictIndex)
    ...
    def setupCFF2(self, charStringsDict, fdArrayList=None, regions=None):
        from .cffLib import (CFFFontSet, CharStrings, FDArrayIndex, FontDict,
                             GlobalSubrsIndex, PrivateDict, TopDict,
                             TopDictIndex)
    ...
    def setupCFF2Regions(self, regions):
        ...
        from .varLib.builder import (buildVarData, buildVarRegionList,
                                     buildVarStore)
