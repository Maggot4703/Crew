...
class DatabaseManager:
    ...
    def __init__(self, db_name="crew_database.db"):
    ...
    def load_data(self, filename: str) -> Tuple[List[str], List[Any], Dict[str, List[Any]]]:
    ...
    def add_validation_rule(self, table: str, column: str, rule_type: str, rule_value: Any) -> None:
                ...
                if column in data.columns:
                    for rule in rules:
                        if rule['type'] == 'not_null':
                            ...
                            if out_of_range.any():
                                errors.append(f"Column {column} contains values outside range [{min_val}, {max_val}]")
        return errors
