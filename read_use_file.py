...
try:
    ...
    try:
        ...
        print("Failed to install pyttsx3. Please install it manually: pip install pyttsx3")
        sys.exit(1)
...
class UseFileReader:
    ...
    def setup_ui(self):
        ...
        self.rate_scale = ttk.Scale(settings_frame, from_=50, to=300, value=150,
        ...
        self.volume_scale = ttk.Scale(settings_frame, from_=0.0, to=1.0, value=1.0,
        ...
        self.load_button = ttk.Button(button_frame, text="Load Selected", 
        ...
        self.stop_button = ttk.Button(button_frame, text="Stop Reading", 
                                     command=self.stop_reading_aloud, state=tk.DISABLED)
        self.stop_button.pack(side=tk.LEFT, padx=5)
        
        self.refresh_button = ttk.Button(button_frame, text="Refresh Files", 
